...
| 添加自身到卡组中 | 每有一友方 |
| 生成次元裂缝N | 当友方被去除时、揭晓时、本回合每置顶过N友方、每揭晓N次、每有一友方、被置顶 |
...
### 全能人 (`ALMIGHTY`) — Rare
- **conditions**: 揭晓时
- **payoffs**: 造成N伤害, 置顶N友方, 埋葬N敌方, 给予友方N力量, 生成次元裂缝N, 增强敌方[诅咒]N
...
- **conditions**: 揭晓时, 被置顶
- **payoffs**: 生成次元裂缝N, 造成N伤害

### 次元引导者 (`RIFT_GUIDE`) — Uncommon
- **conditions**: 揭晓时
- **payoffs**: 去除次元裂缝N, 埋葬N敌方

### 次元虫 (`RIFT_INSECT`) — Common
- **conditions**: 揭晓时
- **payoffs**: 造成N伤害, 生成次元裂缝N

### 次元兽 (`RIFT_MONSTER`) — Uncommon
- **conditions**: 揭晓时
- **payoffs**: 去除次元裂缝N, 造成N伤害

### 裂缝召唤师 (`RIFT_SUMMONER`) — Uncommon
- **conditions**: 揭晓时
- **payoffs**: 去除次元裂缝N, 置顶N友方
